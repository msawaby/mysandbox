...
Ntransient=2*N;         % number of simulation points(more accuracy more higher
...
sim('Sigma_Delta_NLDAC_DWA_RES_SL', (N+Ntransient)/Fs, options);	% Starts Simulink simulation
...
[snr,ptot,psig,pnoise]=calcSNR(yy1,f,1,fB,w',N);
